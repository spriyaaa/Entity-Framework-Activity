...
namespace ActivityEF_DAL
{
    ...
    public partial class AdvConnectDB : DbContext
    {
        public AdvConnectDB()
            : base("name=AdvConnectDB")
        {
        }
        ...
        [DbFunction("AdvConnectDB", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdvConnectDB].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
